...
import { Code, ExternalLink, FileText, Play, Wrench, User, Sparkles, Bot } from 'lucide-react'
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            A modern, full-stack application template with Python FastAPI backend and React TypeScript frontend
          </p>
        </div>
          ...
          <Card className="mb-8 border-blue-200 bg-blue-50/50 dark:border-blue-800 dark:bg-blue-950/50">
            ...
            <CardContent>
              <div className="flex items-center gap-4">
                <div>
                  <p className="font-semibold">{userInfo.displayName || userInfo.userName}</p>
              ...
              <div>
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between items-center">
                    <code className="bg-muted px-2 py-1 rounded text-xs">./setup.sh</code>
                    <span className="text-muted-foreground">Setup environment & dependencies</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <code className="bg-muted px-2 py-1 rounded text-xs">./watch.sh</code>
                    <span className="text-muted-foreground">Start dev servers (background)</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <code className="bg-muted px-2 py-1 rounded text-xs">./fix.sh</code>
                    <span className="text-muted-foreground">Format code (Python + TS)</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <code className="bg-muted px-2 py-1 rounded text-xs">./deploy.sh</code>
                    <span className="text-muted-foreground">Deploy to Databricks Apps</span>
                  </div>
                </div>
              </div>
          ...
          <Card className="h-fit">
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between items-center">
                    <code className="bg-muted px-2 py-1 rounded text-xs">"start the devserver"</code>
                    <span className="text-muted-foreground">Runs ./watch.sh</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <code className="bg-muted px-2 py-1 rounded text-xs">"kill the devserver"</code>
                    <span className="text-muted-foreground">Stops background processes</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <code className="bg-muted px-2 py-1 rounded text-xs">"fix the code"</code>
                    <span className="text-muted-foreground">Runs ./fix.sh</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <code className="bg-muted px-2 py-1 rounded text-xs">"deploy the app"</code>
                    <span className="text-muted-foreground">Runs ./deploy.sh</span>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between items-center">
                    <code className="bg-muted px-2 py-1 rounded text-xs">"add a new API endpoint"</code>
                    <span className="text-muted-foreground">Creates FastAPI routes</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <code className="bg-muted px-2 py-1 rounded text-xs">"create a new React component"</code>
                    <span className="text-muted-foreground">Builds UI components</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <code className="bg-muted px-2 py-1 rounded text-xs">"debug this error"</code>
                    <span className="text-muted-foreground">Analyzes and fixes issues</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <code className="bg-muted px-2 py-1 rounded text-xs">"open the UI in playwright"</code>
                    <span className="text-muted-foreground">Opens app in browser</span>
                  </div>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="h-fit">
            ...
            <CardContent>
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <h4 className="font-semibold mb-3 text-purple-600">Frontend</h4>
                  <ul className="space-y-2 text-sm">
                    <li className="flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h5 className="font-semibold">TypeScript Client Generation</h5>
                    <p className="text-sm text-muted-foreground">
                      Automatically generates TypeScript API client from FastAPI OpenAPI spec
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Instant updates for both Python backend and React frontend changes
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Integrated with Databricks SDK for seamless workspace integration
                    </p>
                  </div>
                </div>
              </div>
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Development servers run in background with comprehensive logging
                    </p>
                  </div>
                </div>
              </div>
